          ...
          <div className="p-8 sm:p-10">
            ...
            <div className="mb-10">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-gray-600">
                  ...
                  <span>
                    Accommodation in a luxury 4-star resort with daily breakfast
                    included.
                  </span>
                </li>
                <li className="flex items-start gap-3 text-gray-600">
                  ...
                  <span>
                    Guided island tours including visits to historic temples and
                    hidden beaches.
                  </span>
                </li>
                <li className="flex items-start gap-3 text-gray-600">
                  ...
                  <span>
                    Round-trip airport transfers and premium transportation
                    during tours.
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-primary-50 rounded-2xl p-8 text-center flex flex-col items-center">
              ...
              <p className="text-gray-600 mb-6 max-w-md">
                Our travel experts are ready to finalize your booking or
                customize this package to fit your exact needs.
              </p>
              <Link href="/contact">
                <Button
                  size="lg"
