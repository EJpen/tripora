          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                We have partnered with top resorts and guides worldwide to
                ensure you get the most authentic premium experience.
              </p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-md transition-shadow">
              <div className="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center mb-6">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                No two travelers are the same. We tailor every itinerary to
                match your specific preferences, pace, and passions.
              </p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-md transition-shadow">
              <div className="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center mb-6">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Your safety is our priority. We thoroughly vet all our partners
                and provide 24/7 support while you are on your trip.
              </p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-md transition-shadow">
              <div className="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center mb-6">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                From booking to your flight back home, we handle all the
                logistics so you can simply focus on enjoying the journey.
              </p>
            </div>
          </div>
        </div>
