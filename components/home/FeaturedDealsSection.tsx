...
const destinations = [
  {
    ...
    description:
      "A comprehensive 10 day travel guide designed to explore the gems and attractions.",
    price: "$840-$890",
    image:
  ...
  },
  {
    ...
    description:
      "A comprehensive 8 day travel guide designed to explore the gems and attractions.",
    price: "$840-$890",
    image:
  ...
  },
  {
    ...
    description:
      "A comprehensive 12 day travel guide designed to explore the gems and attractions.",
    price: "$1150-$1290",
    image:
  ...
  },
  {
    ...
    description:
      "A comprehensive 4 day travel guide designed to explore the gems and attractions.",
    price: "$840-$890",
    image:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          >
            ...
            getaway, mountain trek, or city exploration, we have something
            special!
          </motion.p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="lg:w-1/3 relative rounded-3xl overflow-hidden group min-h-125 lg:min-h-auto"
          >
            ...
            <div className="absolute inset-0 bg-linear-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-8">
              ...
              <div className="flex gap-2 mb-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="w-12 h-12 rounded-full border-2 border-white overflow-hidden bg-gray-200 shadow-md relative"
                  >
                    <Image
                      src={`https://images.unsplash.com/photo-1506929562872-bb421503ef21?q=40&w=100&auto=format&fit=crop&sig=${i}`}
                      alt="Avatar"
                      fill
                      className="object-cover"
                    />
            ...
            {destinations.map((dest, i) => (
              ...
              >
                ...
                <div className="flex items-center justify-between mt-auto">
                  ...
                  <Link
                    href="/results"
                    className="inline-flex items-center gap-1 text-sm font-semibold text-white bg-gray-800 px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors group/btn"
                  >
                    Book Now{" "}
