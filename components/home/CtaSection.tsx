    ...
    <section className="py-24 bg-white px-4 sm:px-6 lg:px-8">
      ...
      >
        <div 
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1542259009477-d625272157b7?q=80&w=2069&auto=format&fit=crop')" }}
        />
        ...
        <div className="relative z-10 py-24 md:py-32 px-6 text-center flex flex-col items-center justify-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl font-medium drop-shadow leading-relaxed">
            Explore the beauty of the world with Tripora. Your next incredible adventure is just a click away!
          </p>
          <Link href="/contact">
            <Button size="lg" className="bg-white text-gray-900 hover:bg-gray-100 px-10 h-16 rounded-full text-lg font-bold shadow-xl transition-transform hover:scale-105 hover:shadow-2xl">
              Get Started Now
            </Button>
          </Link>
        </div>
